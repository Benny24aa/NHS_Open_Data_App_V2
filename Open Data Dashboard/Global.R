...
diagnostics_dashboard_list <- c("Landing Page" = "Diagnostics_Landing Page", "Healthboard Overview" = "Diagnostics_Healthboard_Overview", "Healthboard Comparison" = "Diagnostics_Healthboard_Comparison", "Download Data" = "Diagnostics_Download_Data")
