...
The page includes the ability to filter for different indicators relating to 62-Day Standard for Cancer Waiting Times. Use the filters below to update all visualizations on this page according to cancer type, Health Board, and time period. "),
  ...
  fluidRow(
    column(3, withSpinner(plotlyOutput("cancer_waiting_list_overview_62_days", width = "400%", height = "600px")), type = 4, size = 1.5, color = "blue")),
  ...
  fluidRow(
    column(3, withSpinner(plotlyOutput("cancer_waiting_list_overview_62_days_treatmenthb", width = "400%", height = "600px")), type = 4, size = 1.5, color = "blue")),
  
  uiOutput("Text_62_Days_Eligible_Referals_Treated_Compare"),
  fluidRow(
    column(3, withSpinner(plotlyOutput("cancer_waiting_list_overview_62_days_treatmenthb_compare", width = "400%", height = "600px")), type = 4, size = 1.5, color = "blue"))
