Cancer_Overview <- conditionalPanel(
  ...
  fluidRow(
    column(12, withSpinner(plotlyOutput("scotland_info_graph_server", height = "600px")), type = 4, size = 1.5, color = "blue")   
    
    ),
  uiOutput("Cancer_Sex_Overview"),
  fluidRow(
    column(12, withSpinner(plotlyOutput("scotland_gender_graph_server", height = "600px")), type = 4, size = 1.5, color = "blue")          
