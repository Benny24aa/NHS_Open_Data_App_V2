information <- tabPanel(title = "Home", 
         ...
         fluidRow(
           column(12,
                  ...
                  p("The dashboard will focus mainly on Healthboard, SIMD Deprivation Quinites and Deciles, Gender, and Age break downs across Scotland. The dashboard will have multiple sections which address different health related statitsics. 
